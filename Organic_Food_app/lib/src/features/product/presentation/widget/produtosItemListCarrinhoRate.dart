...
import 'package:pdm/src/features/product/presentation/widget/produteView.dart';
import 'package:pdm/theme_manager.dart';

class ProdutoItemListCarrinhoRate extends StatelessWidget {
  const ProdutoItemListCarrinhoRate({
    Key? key,
                ...
                Padding(
                  ...
                  child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          "Rating:".i18n() +
                              produto.P_ratings.toStringAsFixed(2),
                          style: TextStyle(
                              fontWeight: FontWeight.bold, fontSize: 18),
                        ),
                        Text(
